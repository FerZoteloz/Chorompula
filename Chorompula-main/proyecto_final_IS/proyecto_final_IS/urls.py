...
from accounts.views import login_view, signup_view, dashboard_view, lista_usuarios_view, editar_usuario_view, crear_curso_view, detalle_curso_view, asignar_profesor_view
urlpatterns = [
